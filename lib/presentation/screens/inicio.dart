...
class Inicio extends StatelessWidget {
  ...
  List<String> registros = ['Oscar Gutiérrez Pérez','Ian Horcasitas Pérez','Milton Rodriguez González'];
      ...
      children: [
          ...
          Row(
            ...
            children: <Widget> [
              ...
              }, iconSize: 50, icon: const Icon(Icons.person, color: Colors.black,), alignment: Alignment.topRight,)
            ]
          ),
  ...
  Widget registro(texto,BuildContext context) {
    ...
    child: Column(
    children: <Widget>[
    Text(texto, style: const TextStyle(color: Colors.black, fontSize: 16.0, decoration: TextDecoration.none,), textAlign:TextAlign.center,),
  ...
  Widget boton_registro(BuildContext context) {
    ...
    /* child: TextButton(
      ...
      onPressed: () => print("Registro"), 
      child: Text("Ver Registro", style: TextStyle(fontSize: 17, color: Colors.black, decoration: TextDecoration.none,),)
