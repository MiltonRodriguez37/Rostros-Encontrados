...
class AjustesUsuario extends StatelessWidget {
  const AjustesUsuario({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    body: Center(
      child: Container(
        ...
        decoration: const BoxDecoration(color: Color.fromARGB(255, 250, 249, 249), borderRadius: BorderRadius.all(Radius.circular(15))),
            ...
            Column(
              ...
              children: [
                ...
                child: TextButton.icon(
                  ...
                  label: const Text("Modificar información", style: TextStyle(color: Color.fromARGB(255, 0, 0, 0), fontSize: 22)),
                ...
                child: TextButton.icon(
                  ...
                  label: const Text("Cerrar sesión", style: TextStyle(color: Color.fromARGB(255, 0, 0, 0), fontSize: 22)),
                  style: TextButton.styleFrom(
